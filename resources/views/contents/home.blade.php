        ...
        <div class="absolute w-full min-h-screen">
          ...
          <section class="flex justify-center items-center min-h-screen">
                  ...
                  <div class="flex flex-col space-y-6 justify-between py-4">
                    <div>
                     ...
                     <div class=" inline-flex space-x-4 text-xl">
                       <a href="https://www.linkedin.com/in/ftkarda/" class="bg-white hover:bg-blue-100 rounded-full"> <ion-icon name="logo-linkedin"></ion-icon></a>
              ...
              <nav class="flex-col space-y-6 z-10 md:flex hidden">
                  <a href="{{route('home') }}" class="bg-gradient-to-r from-green-400 to-blue-500 hover:from-pink-500 hover:to-yellow-500 rounded-r-lg py-3 px-6"> <ion-icon name="home-outline"></ion-icon> Home</a>
